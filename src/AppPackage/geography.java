...
public class geography {
    ...
    //----------------------methods for geography marks process checks-------------------------
    ...
    String classx, String Term, String Year, String className){
        ...
        if(edit.equals("no")){
                  ...
                  String sql = "insert into raw_marks (name,admin_nos,house,term,class,class_name,year,exam_type,geography)values(?,?,?,?,?,?,?,?,?)";
                  conn=connect.ConnecrDb(); 
                  pst=conn.prepareStatement(sql);
                  ...
                  pst.execute();
                    ...
                    try{
                        ...
                        String sql = "update raw_marks set geography = ? where admin_nos = ? and term = ? and class = ? and class_name = ? and year = ? and exam_type = ? ";
                        conn=connect.ConnecrDb(); 
                        pst=conn.prepareStatement(sql);
    ...
    public void prossFinalMark(String admin_nos,String classx, String Term, String Year){
        ...
        try{
          ...
          conn=connect.ConnecrDb();
          String sql = "SELECT (select geography from raw_marks where admin_nos = '"+admin_nos+"' and exam_type = 'EN' and term = '"+Term+"' and class = '"+classx+"' and year = '"+Year+"') AS 'EN', " +
"(select geography from raw_marks where admin_nos = '"+admin_nos+"' and exam_type = 'MD' and term = '"+Term+"' and class = '"+classx+"' and year = '"+Year+"') AS 'MD', " +
"(select geography from raw_marks where admin_nos = '"+admin_nos+"' and exam_type = 'ED' and term = '"+Term+"' and class = '"+classx+"' and year = '"+Year+"') AS 'ED' " +
"from raw_marks where admin_nos = '"+admin_nos+"' and term = '"+Term+"' and class = '"+classx+"' and year = '"+Year+"' limit 1 ";
         ...
         if(rs.next()){
                ...
                mainFrame.txt_finalMarksGeo.setText(""+final_marks);
    ...
    public void populateFinalMarks( String fullName, String admin_nos, String house, String classx, String Term,
        ...
        if(final_edit.equals("no")){
                  ...
                  String sql = "insert into final_marks (name,admin_nos,house,term,class,class_name,year,geography,geography_g,gender,geo_rem)values(?,?,?,?,?,?,?,?,?,?,?)";
                  conn=connect.ConnecrDb(); 
                  pst=conn.prepareStatement(sql);
                  pst.setString(1, fullName);
                  pst.setString(2, admin_nos);
                  ...
                  pst.setString(6, className);
                  pst.setString(7, Year);
                  pst.setString(8, mainFrame.txt_finalMarksGeo.getText());
                  pst.setString(10, gender);
                  int avg_m = Integer.parseInt(mainFrame.txt_finalMarksGeo.getText());
                  ...
                  pst.execute();
                  mainFrame.txt_finalMarksGeo.setText("");
                    ...
                    try{
                        ...
                        String sql = "update final_marks set geography = ?, geography_g = ?, gender = ?, geo_rem = ? where admin_nos = ? and term = ? and class = ? and class_name = ? and year = ? ";
                        conn=connect.ConnecrDb(); 
                        pst=conn.prepareStatement(sql);
                        pst.setString(1, mainFrame.txt_finalMarksGeo.getText());
